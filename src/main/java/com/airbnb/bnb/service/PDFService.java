...
public class PDFService {
    ...
    public void generatePdf(Booking booking) {
        ...
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("D://bnb_bookings//"+booking.getId()+"_booking_confirmation.pdf"));
            ...
            emailService.sendEmailWithAttachment(
                    ...
                    "test",
                    new File("D://bnb_bookings//"+booking.getId()+"_booking_confirmation.pdf")
